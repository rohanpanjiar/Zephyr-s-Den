...
- **~2–4 weeks after filing** — USCIS mails receipt notices (Form I-797C) for each form.
- **~3–6 weeks** — Biometrics appointment (fingerprints/photo) at the LA ASC.
- **~3–5 months** — **EAD + Advance Parole combo card** arrives → Rohan can work and can
  travel internationally again.
- **~8–16 months** — Green card interview at the local USCIS field office (Los Angeles),
  then approval. If married <2 years at approval, the first green card is conditional
  (2 years); you file I-751 to remove conditions later.

> Hard rule until the combo card arrives: no international travel for Rohan unless he
> holds H-1B/L-1 status (confirm in Open Questions).
